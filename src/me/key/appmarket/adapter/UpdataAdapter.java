...
public class UpdataAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.updata_manager_list_item,
					null);
			holder.info = (TextView) convertView.findViewById(R.id.info);
			holder.icon = (ImageView) convertView.findViewById(R.id.icon);
			holder.operate = (ImageView) convertView
		 ...
		 * null, null);
		 * 
		 * v2.btn.setText("安装"); v2.progress_view.setProgress(0);
		 */
		...
		holder.btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(context, sdappInfo.getAppName() + " 开始下载...",
