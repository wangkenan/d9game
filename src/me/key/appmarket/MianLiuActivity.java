 ...
 *
 */
public class MianLiuActivity extends FinalActivity {
	//返回键
	...
	private void fillData(final String tag) {
		...
		packages = MianLiuActivity.this.getPackageManager().getInstalledPackages(0);
		nextoronkey.setText("一键安装");
		titlename_onekey.setText("免流专区");
		new AsyncTask<Void, Void, Void>() {
			...
			protected Void doInBackground(Void... params) {
				...
				recomApp = LocalUtils.InitHomePager(tag,
						MianLiuActivity.this, root,packages);
				return null;
			}
			@Override
			protected void onPostExecute(Void result) {
				...
				onekAdapter = new OnKeyAdapter(MianLiuActivity.this, recomApp,checkApp);
